...
public: 
	 ...
	 */
	virtual T_String toString(IProperty const *const property) const
	{
...
private:
	 ...
	 */
	template<typename T>
	T_String serialize(IProperty const *const property) const
	{	
		Property<T> const *const prop = static_cast<Property<T> const *const>(property);
