...
int irrWeatherManager::getRandom(int lim, int seed)
{
    static long a = seed;
...
ICloudLayer* irrWeatherManager::getCloudLayerByIndex(u32 index)
{
...
u32 irrWeatherManager::getCloudLayerCount()
{
