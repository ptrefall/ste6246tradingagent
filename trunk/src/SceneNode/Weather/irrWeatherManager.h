...
#define IRR_WEATHER_MANAGER_VER_MICRO 5
...
class irrWeatherManager
{
    public:
        ...
        */
        ...
        ICloudLayer* getCloudLayerByIndex(irr::u32 index);

        irr::u32 getCloudLayerCount();

        int getRandom(int lim, int seed);

        irr::f32 getLightningFrequency() { return lightningFrequency; };
