...
void IWeatherManagerAtmosphere::CreateSkyPallete()
{
        ...
        dangus=driver->getTexture("../../bin/resources/Sky/sky2.tga");

        //stars box
        ISceneNode* skybox = smgr->addSkyBoxSceneNode(
            driver->getTexture("../../bin/resources/Sky/stars_top.png"),
            driver->getTexture("../../bin/resources/Sky/stars_bottom.png"),
            driver->getTexture("../../bin/resources/Sky/stars.png"),
            driver->getTexture("../../bin/resources/Sky/stars.png"),
            driver->getTexture("../../bin/resources/Sky/stars.png"),
            driver->getTexture("../../bin/resources/Sky/stars.png"));
        ...
        //sun billboard
        bill=new IAtmosphereStarSceneNode(smgr->getRootSceneNode(),smgr,0, core::vector3df(0,0,0),core::dimension2d<f32>(150,150));
        bill->setMaterialFlag(video::EMF_LIGHTING, false);
        bill->setMaterialTexture(0, driver->getTexture("../../bin/resources/Sky/sun.tga"));
