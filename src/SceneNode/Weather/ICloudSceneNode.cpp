...
//! constructor
ICloudSceneNode::ICloudSceneNode(ISceneNode* parent, ISceneManager* mgr, ITimer *devicetimer , s32 id,
	...
	ZOrdering(true), IgnoreChildColor(false), MaxDepth(2), LOD(10), timer(devicetimer), SkyMoveFactor(1.0f)
{
    ...
    DefaultColor = irr::video::SColor(255,255,255,255);
}
...
s16 ICloudSceneNode::getCurrentCloudCount()
{
